...
function checkoutBranch(branch) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, exec_1.exec("git fetch")
...
function commit(commitMessage) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, exec_1.exec("git config --local user.email \"41898282+github-actions[bot]@users.noreply.github.com\"").then(function (exitCode) {
                        if (exitCode)
...
function push() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, exec_1.exec("git push")];
                case 1:
                    exitCode = _a.sent();
                    if (exitCode)
                        throw new Error("Error pushing code\n");
